use crate::mcp::config::{McpServerConfig, ScopedMcpServerConfig};
...
fn render_oauth_signature(oauth: Option<&crate::mcp::config::McpOAuthConfig>) -> String {
    oauth.map_or_else(String::new, |oauth| {
        format!(
            ...
            oauth.xaa.map_or_else(String::new, |flag: bool| flag.to_string())
        )
    })
}
